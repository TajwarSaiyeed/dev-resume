...
const EditSkillSection = () => {
  ...
  return (
    <div
      className={
        "border p-3 rounded-md flex flex-wrap justify-between gap-2 my-3 bg-green-200"
      }
    >
      <div
        className={`
          ...
          <Card key={sk.id} className={"w-full"}>
            ...
            >
              ...
              <EditSkillItem
                ...
                item_name={"value"}
                placeholder={
                  "e.g. 'Next.js, TypeScript, Prisma ORM, React-hook-form, Zustand, etc.'"
                }
                value={sk.value}
                data={skills}
                sk={sk}
      ...
      <Button onClick={handleAddNewSkillData}>Add New Skill Item</Button>
    </div>
  );
};
